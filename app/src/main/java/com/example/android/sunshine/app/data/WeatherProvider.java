...
public class WeatherProvider extends ContentProvider {
    ...
    private Cursor getLocation(Uri uri, String[] projection, String sortOrder) {
        ...
        String selection = "";  //No filter
        String[] selectionArgs = new String[]{};    //No filter
    ...
    private Cursor getWeather(Uri uri, String[] projection, String sortOrder) {
        ...
        String selection = "";  //No filters
        String[] selectionArgs = new String[]{};    //No filters
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        if (selection == null) { selection = "1"; };    //In order to get the number of deleted rows when all
        ...
        if ( numRowsDeleted != 0 ) //if locationSettings is null - all records are deleted
        {
            getContext().getContentResolver().notifyChange(uri, null);
        }
